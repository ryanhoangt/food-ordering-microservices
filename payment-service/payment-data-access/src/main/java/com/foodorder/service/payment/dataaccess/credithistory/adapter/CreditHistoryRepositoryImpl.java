package com.foodorder.service.payment.dataaccess.credithistory.adapter;
...
import com.foodorder.service.payment.dataaccess.credithistory.mapper.CreditHistoryDataAccessMapper;
import com.foodorder.service.payment.dataaccess.credithistory.repository.CreditHistoryJpaRepository;
...
public class CreditHistoryRepositoryImpl implements CreditHistoryRepository {
    ...
    public Optional<List<CreditHistory>> findByCustomerId(CustomerId customerId) {
        Optional<List<CreditHistoryEntity>> creditHistory =
                creditHistoryJpaRepository.findByCustomerId(customerId.getIdValue());
