...
@Slf4j
@Component
public class PaymentCompletedKafkaMsgPublisher implements PaymentCompletedMsgPublisher {
    ...
    public PaymentCompletedKafkaMsgPublisher(PaymentMessagingDataMapper paymentMessagingDataMapper,
    ...
    public void publish(PaymentCompletedEvent domainEvent) {
        ...
        PaymentResponseAvroModel responseAvroModel =
                paymentMessagingDataMapper.fromPaymentCompletedEventToPaymentResponseAvroModel(domainEvent);
        try {
            kafkaProducer.send(
