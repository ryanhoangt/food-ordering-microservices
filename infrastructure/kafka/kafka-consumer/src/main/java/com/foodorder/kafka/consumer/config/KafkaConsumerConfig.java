package com.foodorder.kafka.consumer.config;

import com.foodorder.kafka.config.data.KafkaConfigData;
import com.foodorder.kafka.config.data.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        System.out.println("Bootstrap server size: " + kafkaConfigData.getBootstrapServers().length());
